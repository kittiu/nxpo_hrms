...
def get_salary_slips(date_range, company=None, field=None, employee=None, limit=None):
	...
	salary_slips = frappe.get_list(
		doctype="Salary Slip",
		fields=["name", "posting_date as month_period", select_field, "employee_name", 'custom_date_for_split_tax_component as date_for_split_tax_component'],
		filters=filters
	)
...
def get_wht_cert_employee(date_range, company=None, field=None, employee=None, limit=None):
	...
	salary_slips = frappe.get_list(
		...
		fields=["name","date as month_period", select_field, "employee_name"],
		filters=filters
	)
