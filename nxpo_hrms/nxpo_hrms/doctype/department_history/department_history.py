...
class DepartmentHistory(NestedSet):
	...
	if TYPE_CHECKING:
		...
		parent_department_history: DF.Link | None
		rgt: DF.Int
	# end: auto-generated types

	nsm_parent_field = "parent_department_history"
	...
	def validate(self):
		if not self.parent_department_history:
			root = get_root_of("Department")
			if root:
				self.parent_department_history = root
...
def get_children(doctype, parent=None, company=None, is_root=False):
	...
	if company == parent:
		...
		filters["parent_department_history"] = parent
...
def add_node():
	...
	if args.parent_department_history == args.company:
		args.parent_department_history = None
