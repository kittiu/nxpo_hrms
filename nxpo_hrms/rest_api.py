...
ECM_TO_FRAPPE = {
    ...
    "current_village_building": "custom_village_building",
    ...
    "permanent_perm_village_building": "custom_perm_village_building",
...
def _sql_employee():
    return """
        select emp.name as EMPLOYEE_CODE,
            ...
            emp.custom_village_building as CURRENT_VILLAGE_BUILDING,
            ...
            emp.custom_perm_village_building as PERMANENT_VILLAGE_BUILDING,
